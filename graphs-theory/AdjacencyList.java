...
public class AdjacencyList {
    ...
    public static void main(String[] args) {
        ...
        HashMap<String, ArrayList<String>> adjList = adjacencyList.buildAdjList();
        ...
        int totalPaths = adjacencyList.dfs(startNode, targetNode, adjList, visitedSet);
        System.out.println("Total paths from A to D: " + totalPaths);
    
        // Test BFS
        int shortestPathLength = adjacencyList.bfs(startNode, targetNode, adjList);
